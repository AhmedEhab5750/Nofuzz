...
```bash
chmod +x simple-dirb.sh
./simple-dirb.sh <base_url> <wordlist_file> [extensions]
```

**Example:**
```bash
./simple-dirb.sh https://target.com/ /usr/share/wordlists/dirb/common.txt "php,js,bak"
```
...
**Example with tuning:**
```bash
THREADS=20 DELAY=0.5 TIMEOUT=5 ./simple-dirb.sh https://target.com/ wordlist.txt
```
